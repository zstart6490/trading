...
class TransactionCreateState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var desc = "";
    var desc2 = "";
    // desc = transaction.stat ?? "";
    // if (!desc.hasText) {
    //   desc = "Tikop đang kiểm tra và xử lý giao dịch này trong vòng 24h";
    // }
    // if (transaction.getMethod == TransactionMethod.bankTransferGlobal) {
    //   desc =
    //       "Đối tác của Tikop sẽ liên hệ với bạn trong vòng 24h tới để tiếp nhận số tiền";
    //   desc2 =
    //       "Trước khi giao tiền, bạn cần mở chi tiết giao dịch và nhập mã của đối tác để xác nhận";
    // }
    // if (transaction.hasFunds) {
    //   desc = "Tikop đang xử lý giao dịch rút tiền của bạn ";
    //   if (transaction.getType == TransactionType.withdraw) {
    //     desc2 = "(Đang bán các chứng chỉ quỹ)";
    //   }
    // }

    steps = [
      StepData.step1(),
      StepData.step2(desc: desc, descLv2: desc2),
    ];
