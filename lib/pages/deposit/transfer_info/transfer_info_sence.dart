...
class TransferInfoScene extends GetView<TransferInfoController> {
  const TransferInfoScene({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BaseScaffoldAppBar<TransferInfoController>(
