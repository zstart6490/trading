...
class OverlayWidget extends GetView<TransferInfoController> {
  const OverlayWidget({
    Key? key,
          ...
          Positioned(
            ...
            child: optionGuide == OptionGuide.bankAccount
                ? ViewAccountNumber(
                    ...
                    accountNumber: controller.banks.first.accountNumber??"",
                  )
                : const SizedBox.shrink(),
          ),
          Positioned(
            ...
            child: optionGuide == OptionGuide.paymentContent
                ? ViewPaymentContent(
                    ...
                    content: controller.data.transaction?.content ?? "",
                  )
                : const SizedBox.shrink(),
          )
        ],
