                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SIZED_BOX_H16,
                      buildContent(
                          context, widget.config.manualBankContent1 ?? ""),
                      SIZED_BOX_H12,
                      if (showDesc)
                        Column(
                          children: [
                            buildContent(context,
                                widget.config.manualBankContent2 ?? ""),
                            SIZED_BOX_H12,
                            buildContent(context,
                                widget.config.manualBankContent3 ?? ""),
                            SIZED_BOX_H12,
                          ],
                        ),
                      Row(
                        children: [
                          ...
                          Text(
                            widget.config.manualBankTransferFee ?? "0 VNĐ",
                            style: context.textSize12
