...
class StTransactionProgressingState extends StatelessWidget {
  final StockTransactionDetail transaction;

  const StTransactionProgressingState({
    Key? key,
  ...
  Widget build(BuildContext context) {
    List<StepData> steps = [];
    const desc = "Tikop đang kiểm tra và sẽ xử lý giao dịch này trong phiên giao dịch sớm nhất.";
